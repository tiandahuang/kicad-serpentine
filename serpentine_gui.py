...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.top_text = wx.StaticText( self.MainPanel, wx.ID_ANY, u"Size and Shape Parameters", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.r_label = wx.StaticText( self.MainPanel, wx.ID_ANY, u"Radius (mm)", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.r_label.Wrap( -1 )

		ParamsSizer.Add( self.r_label, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.r_value = wx.TextCtrl( self.MainPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		ParamsSizer.Add( self.r_value, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.a_label = wx.StaticText( self.MainPanel, wx.ID_ANY, u"Amplitude (mm)", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.a_label.Wrap( -1 )

		ParamsSizer.Add( self.a_label, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.a_value = wx.TextCtrl( self.MainPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		ParamsSizer.Add( self.a_value, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.alph_label = wx.StaticText( self.MainPanel, wx.ID_ANY, u"Alpha (deg)", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.alph_label.Wrap( -1 )

		ParamsSizer.Add( self.alph_label, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.alph_value = wx.TextCtrl( self.MainPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		ParamsSizer.Add( self.alph_value, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.len_label = wx.StaticText( self.MainPanel, wx.ID_ANY, u"Length (mm)", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.len_label.Wrap( -1 )

		ParamsSizer.Add( self.len_label, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, 5 )

		self.len_value = wx.TextCtrl( self.MainPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		ParamsSizer.Add( self.len_value, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.pitch_label = wx.StaticText( self.MainPanel, wx.ID_ANY, u"Wire Spacing (mm)", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.pitch_label.Wrap( -1 )

		ParamsSizer.Add( self.pitch_label, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.pitch_value = wx.TextCtrl( self.MainPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		ParamsSizer.Add( self.pitch_value, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.edgedisable_label = wx.StaticText( self.MainPanel, wx.ID_ANY, u"Disable Edges", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.edgedisable_label.Wrap( -1 )

		ParamsSizer.Add( self.edgedisable_label, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.edgedisable_value = wx.CheckBox( self.MainPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.CHK_2STATE )
		ParamsSizer.Add( self.edgedisable_value, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )


		_MainSizer.Add( ParamsSizer, 0, wx.EXPAND, 5 )

		self.m_staticline1 = wx.StaticLine( self.MainPanel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL )
		_MainSizer.Add( self.m_staticline1, 0, wx.EXPAND|wx.RIGHT|wx.LEFT, 20 )
		...
		self.wc_label = wx.StaticText( self.MainPanel, wx.ID_ANY, u"Wire Count", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.wc_label.Wrap( -1 )

		TraceParamsSizer.Add( self.wc_label, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

		self.width_label = wx.StaticText( self.MainPanel, wx.ID_ANY, u"Wire Width (mm)", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.width_label.Wrap( -1 )

		TraceParamsSizer.Add( self.width_label, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.f_cu_label = wx.StaticText( self.MainPanel, wx.ID_ANY, u"Front Copper", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.f_cu_label.Wrap( -1 )

		TraceParamsSizer.Add( self.f_cu_label, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.f_wc_value = wx.TextCtrl( self.MainPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		TraceParamsSizer.Add( self.f_wc_value, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.f_width_value = wx.TextCtrl( self.MainPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		TraceParamsSizer.Add( self.f_width_value, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.b_cu_label = wx.StaticText( self.MainPanel, wx.ID_ANY, u"Back Copper", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.b_cu_label.Wrap( -1 )

		TraceParamsSizer.Add( self.b_cu_label, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.b_wc_value = wx.TextCtrl( self.MainPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		TraceParamsSizer.Add( self.b_wc_value, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.b_width_value = wx.TextCtrl( self.MainPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		TraceParamsSizer.Add( self.b_width_value, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )


		_MainSizer.Add( TraceParamsSizer, 1, wx.EXPAND, 5 )


		_MainSizer.Add( ( 0, 0), 1, wx.EXPAND, 5 )

		confirm_box = wx.StdDialogButtonSizer()
		self.confirm_boxOK = wx.Button( self.MainPanel, wx.ID_OK )
		confirm_box.AddButton( self.confirm_boxOK )
		self.confirm_boxApply = wx.Button( self.MainPanel, wx.ID_APPLY )
		confirm_box.AddButton( self.confirm_boxApply )
		self.confirm_boxCancel = wx.Button( self.MainPanel, wx.ID_CANCEL )
		confirm_box.AddButton( self.confirm_boxCancel )
		confirm_box.Realize();

		_MainSizer.Add( confirm_box, 0, wx.EXPAND, 5 )


		self.MainPanel.SetSizer( _MainSizer )
		self.MainPanel.Layout()
		_MainSizer.Fit( self.MainPanel )
